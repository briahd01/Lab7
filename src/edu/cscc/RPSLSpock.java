...
public class RPSLSpock {
    ...
    /**
     * Uses if statement to determine if the input is valid
     * @param pick takes the input of the user h_pick
     * @return the value in the constant
     */
    ...
    /**
     * Generate if the computer wins
     * @param c_pick the computer pick
     * @param h_pick the users pick
     * @return if c_pick equals RPSLSpock that beats h_pick
     */
